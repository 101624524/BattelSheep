...
/// <summary>
/// The AIEasyPlayer is a AIPlayer that just shoots randomly
/// </summary>
public class AIEasyPlayer : AIPlayer
{
    ...
    /// <summary>
    /// GenerateCoordinates should generate random coordinates
    ...
    /// <summary>
    /// will randomly generate shots within the grid as long as its not hit that tile already
    /// </summary>
    /// <param name="row">the generated row</param>
    /// <param name="column">the generated column</param>
